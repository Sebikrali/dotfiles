...
-- vim.keymap.set("t", "<leader><Esc>p, "<C-\\><C-n>", { desc = "Exit terminal mode" })
...
vim.api.nvim_create_autocmd("ColorScheme", {
	...
	callback = function()
		...
		vim.cmd(
			"set guicursor=n-v-c-i:block,i-ci-ve:block-Cursor_insert/lCursor_insert,r:block-Cursor_replace/lCursor_replace"
		)
	end,
})
